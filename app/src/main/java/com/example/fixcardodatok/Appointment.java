...
public class Appointment extends AppCompatActivity {
    ...
    Button buttonAppointmentCreate;

    Spinner spinnerMarka, spinnerModel, spinneryear ,spinnerYakit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonAppointmentCreate = (Button)findViewById(R.id.AppointmentCreate);
        ...
        buttonAppointmentCreate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String marka, model, year, plaka, kilometre, yakit;
                ...
                if (!marka.equals("") && !model.equals("") && !year.equals("") && !plaka.equals("") && !kilometre.equals("") && !yakit.equals("")){
                    ...
                    handler.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            PutData putData = new PutData("http://192.168.31.118/LoginRegister/CarInformation.php", "POST", field, data);
                            if (putData.startPut()) {
                                if (putData.onComplete()) {
                                    //progressBar.setVisibility(View.GONE);
                                    String result = putData.getResult();
                                    if (result.equals("Видалення здійснено успішно!"))
                                    {
    ...
    private void initializeMarkaModelMap() {
        ...
        bmwModels.add("6 Series");
        bmwModels.add("7 Series");
        bmwModels.add("X1");
        bmwModels.add("X2");
        bmwModels.add("X3");
        bmwModels.add("X5");
